...
# cells<-c(52,78,104,106,107,122,129,131,138,
...
# 758,760,762,764,766,768,770,772,774,776,794,795,831:834,
# 840:841)
# 
...
# # add comma
# 
# gsub(" ",",","51  77 103 105 106 121 128 130 137 139 146 148 155 157 164 166
# 170 174 191 198 200 207 209 216 218 225 227 234 236 240 244 262
# 264 268 270 274 276 280 282 286 288 292 298 304 325 327 331 333
# 337 339 343 345 349 351 355 361 367 391 395 399 403 407 411 415
# 419 423 427 431 435 439 443 447 451 455 459 463 467 471 475 479
# 483 489 491 497 499 505 507 513 515 521 523 529 531 537 550 554
# 558 562 566 570 574 696 705 578 582 586 590 594 598 602 606 610
# 614 618 622 626 630 634 638 642 648 650 656 658 664 666 672 674
# 680 682 688 690 707 709 711 713 715 717 719 721 723 725 727 729
# 731 749 751 753 755 757 759 761 763 765 767 769 771 773 775 793
# 794 830 831 832 833 839 840",fixed=T)
...
gibushon_civil_zscore_relevant_columns <- colnames(gibushon_civil 
                                          [c(20:21,23:26,28:32,34:35,43,47:48,51,78,104,106,
                                             #from here add 1 and check all
                                             121,128,130,137,
...
gibushon_final_relevant_predictors_columns_for_correlations <- gibushon_final[c(1055:1058,1062:1064)]
gibushon_final_relevant_predictors_columns_names_for_correlations <- c(colnames(gibushon_final[c(1055:1058,1062:1064)]))
...
gibushon_final_relevant_criteria_columns_for_spcorrelations <- gibushon_final[c(1055:1058,1062:1064)]
gibushon_final_relevant_criteria_columns_names_for_spcorrelations <- c(colnames(gibushon_final[c(1055:1058,1062:1064)]))
gibushon_final_spcorr_output<-data.frame()[15,]
