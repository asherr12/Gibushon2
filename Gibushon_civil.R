...
gibushon_civil_zscore_relevant_columns <- colnames(gibushon_civil 
                                          [c(22:27,29:33,76,103,106,107,122,129,131,138,140,147,149,156,
                                             158,165,167,171,175,192,199,201,208,210,217,219,226,228,235,
                                             237,241,245,263,265,269,271,275,277,281,283,287,289,293,299,
                                             305,326,328,332,334,338,340,344,346,350,352,356,362,368,392,
                                             396,400,404,408,412,416,420,424,428,432,436,440,444,448,452,
                                             456,460,464,468,472,476,480,484,490,492,498,500,506,508,514,
                                             516,522,524,530,532,538,551,555,559,563,567,571,575,697,706,
                                             579,583,587,591,595,599,603,607,611,615,619,623,627,631,635,
                                             639,643,649,651,657,659,665,667,673,675,681,683,689,691,708,
                                             710,712,714,716,718,720,722,724,726,728,730,732,750,752,754,
                                             756,758,760,762,764,766,768,770,772,774,776,794,795)])
...
library(psych)
options(width = 71,max.print=30000)
round(freq(ordered(as.numeric(unlist(gibushon_civil$rama_score))), plot = F,main=colnames(gibushon_civil$rama_score),font=2),2)
